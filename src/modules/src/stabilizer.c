...
void switchEstimator(StateEstimatorType estimator)
{ 
...
void setControllerType(ControllerType newController)
{ 
	if(newController < 0 || newController > ControllerType_COUNT)
	{ 
		return;
	} 
